module.exports = function(app, models) {
  ...
  function deleteFollowedBy(req, res) {
    followModel.deleteFollowedBy(req.params.userId).then(
      function(stats) {
        console.log(stats);
        res.send(200);
      },
  ...
  function deleteFollowing(req, res) {
    followModel.deleteFollowing(req.params.userId).then(
      function(stats) {
        console.log(stats);
        res.send(200);
      },
  ...
  function findFollow(req, res) {
    followModel.findFollow(req.params.userId, req.params.otherUserId).then(
  ...
  function addFollow(req, res) {
    ...
    followModel.findFollow(req.params.userId, req.params.otherUserId).then(
      function(followObj) {
        if (followObj == null) {
          followModel.addFollow(follow).then(
  ...
  function findAllFollowedByUserId(req, res) {
    followModel.findAllFollowedByUserId(req.params.userId).then(
  ...
  function unfollowUser(req, res) {
    followModel.unfollowUser(req.params.userId, req.params.otherUserId).then(
  ...
  function findAllFollowingUserId(req, res) {
    followModel.findAllFollowingUserId(req.params.userId).then(
      function(followingObj) {
        res.json(followingObj);
      },
      function(error) {
