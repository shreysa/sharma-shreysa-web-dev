...
module.exports = function(app, models) {
  ...
  function findFriend(name, res) {
    userModel.findFriend(name).then(
      function(users) {
        res.json(users);
      },
      function(error) {
  ...
  function uploadImage(req, res) {
    ...
    userModel.updateUser(userId, userPhoto).then(
      function(stats) {
  ...
  function makeAdmin(req, res) {
    userModel.makeAdmin(req.params.userId).then(
      function(stats) {
        res.send(200);
      },
      function(error) {
  ...
  function deleteAdmin(req, res) {
    userModel.deleteAdmin(req.params.userId).then(
