module.exports = function(app, models) {
  ...
  app.get(
    "/api/projectuser/restaurant/category/type/:category",
    findRestaurantByCategory
  );
  app.post(
    "/api/projectuser/rating/for/Restaurant/visited/",
    findRestaurantByRating
  );
  app.get("/api/restaurant/city/:city", findRestaurantByCity);

  function findRestaurantByCity(req, res) {
    categoryModel.findRestaurantByCity(req.params.city).then(
      function(catRestObj) {
        res.json(catRestObj);
      },
      function(error) {
  ...
  function findRestaurantByCategory(req, res) {
    ...
    categoryModel.findRestaurantByCategory(category).then(
      function(catRestObj) {
        res.json(catRestObj);
      },
      function(error) {
  ...
  function findRestaurantByRating(req, res) {
    ...
    categoryModel.findRestaurantByRating(ratingForRest).then(
      function(catRestObj) {
        res.json(catRestObj);
      },
      function(error) {
